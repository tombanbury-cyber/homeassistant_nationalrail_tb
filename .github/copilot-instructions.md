...
## Project Overview
This is a Home Assistant Custom Component (HACS) integration for tracking UK train movements using National Rail data.  
...
**Process:**
1. Read the current version from `custom_components/nationalrailuk/manifest.json`
